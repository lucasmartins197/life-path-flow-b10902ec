...
import { abrirCheckoutStripe, checarAssinaturaAtiva, ehAppNativo } from "@/lib/checkout";
          ...
          <Card>
            <CardContent className="p-6 space-y-6">
              ...
              {/* Alternativa de pagamento via Pix pelo WhatsApp da clinica.
                  ...
                  de assinatura para fora do sistema dela (causa rejeicao).
                  No iPhone, o usuario usa apenas o pagamento da Apple. */}
              {!isIOSNative() && (
              <>
              ...
              <a
                href={`https://wa.me/5516981916656?text=${encodeURIComponent(
                  "Olá! Quero assinar o Saindo do Jogo pagando via Pix. Podem me ajudar?"
                )}`}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full inline-flex items-center justify-center gap-2 h-12 text-base rounded-md font-medium bg-[#25D366] hover:bg-[#1FB855] text-white transition-colors"
              >
              ...
              <p className="text-xs text-center text-muted-foreground px-2">
                Prefere pagar via Pix? Fale com nossa equipe pelo WhatsApp e
                concluímos sua assinatura por lá.
              </p>
              </>
              )}
            </CardContent>
